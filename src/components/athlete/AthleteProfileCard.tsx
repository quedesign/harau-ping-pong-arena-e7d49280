              ...
              <div className="w-full space-y-4">
                ...
                {profile.gripStyle && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-auto">
                      {profile.gripStyle === "shakehand" ? "Clássica" : 
                       profile.gripStyle === "penhold" ? "Caneta" : 
                       profile.gripStyle === "seemiller" ? "Seemiller" : "Outras"}
                    </span>
                  </div>
                )}
                ...
                {profile.playFrequency && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-auto">
                      {profile.playFrequency === "daily"
                        ? "Diariamente"
                        : profile.playFrequency === "weekly"
                        ? "Semanalmente"
                ...
                {profile.tournamentParticipation && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-auto">
                      {profile.tournamentParticipation === "local"
                       ? "Locais"
                       : profile.tournamentParticipation === "regional"
                       ? "Regionais"
                       : profile.tournamentParticipation === "national"
                       ? "Nacionais"
                       : profile.tournamentParticipation === "international"
                       ? "Internacionais"
                       : "Não participa"}
                    </span>
                  </div>
