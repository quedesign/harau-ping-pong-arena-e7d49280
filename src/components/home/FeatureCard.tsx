...
const FeatureCard = ({ icon, titleKey, descKey }: FeatureCardProps) => {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col items-center text-center hover:border-zinc-700 transition-colors flex-col">
