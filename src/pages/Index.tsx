...
import { Check, Trophy, Users, FileCheck, Handshake } from 'lucide-react';
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="bg-[#1A1A1A] rounded-xl p-8 h-fit text-center flex flex-col items-center">
                            ...
                            <p className="text-zinc-400 text-sm">Crie ou participe de competições</p>
                        </div>
                        ...
                        <div className="bg-[#1A1A1A] rounded-xl p-8 h-fit text-center flex flex-col items-center">
                            ...
                            <h3 className="text-xl font-bold mb-2">Matchs</h3>
                            <p className="text-zinc-400 text-sm">Conecte-se com atletas próximos</p>
                        </div>
                        ...
                        <div className="bg-[#1A1A1A] rounded-xl p-8 h-fit text-center flex flex-col items-center">
                            ...
                            <p className="text-zinc-400 text-sm">Tenha acesso a treinos personalizados</p>
                        </div>
                        ...
                        <div className="bg-[#1A1A1A] rounded-xl p-8 h-fit text-center flex flex-col items-center">
                            ...
                            <p className="text-zinc-400 text-sm">Acompanhamento com um profissional</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className=" py-20 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-zinc-400 max-w-2xl mx-auto">O Harau oferece ferramentas poderosas tanto para jogadores quanto para administradores de torneios.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div className=" border border-zinc-800 rounded-xl p-8 h-fit">
                            ...
                            <ul className="space-y-4">
                                {["Crie torneios eliminatórios ou todos contra todos", "Gere chaves de torneios automaticamente", "Gerencie inscrições e classificação dos participantes", "Crie páginas de divulgação para torneios", "Aceite pagamentos via PIX para inscrições"].map((feature, index) => (<li key={index} className="flex items-start">
                                    <Check className="h-5 w-5 text-primary mr-3 mt-1 flex-shrink-0"/>
                                    <span>{feature}</span>
                                </li>))}
                            </ul>
